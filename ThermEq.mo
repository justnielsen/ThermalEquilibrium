package TermEq "Excercise in thermodynamic equilibrium"
  ...
  package Components
    model Weight "Weight with a thermal inertia"
      ...
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics = {Rectangle(extent = {{-60,60},{40,-80}}, lineColor = {135,135,135}, fillPattern = FillPattern.VerticalCylinder, fillColor = {199,169,0}, lineThickness = 0.5),Ellipse(extent = {{-30,100},{10,60}}, lineColor = {135,135,135}, fillPattern = FillPattern.Sphere, fillColor = {199,169,0}),Text(extent = {{-60,-80},{40,-100}}, lineColor = {0,0,0}, fillPattern = FillPattern.Sphere, fillColor = {199,169,0}, textString = "%name"),Text(extent = {{-60,20},{40,-40}}, lineColor = {0,0,0}, fillPattern = FillPattern.Sphere, fillColor = {199,169,0}, textString = "kg")}));
    end Weight;
    model GlasOfWater "Cylindrical glass of water filled to the top and some displacement some of the water"
      extends ThermalCapacitance;
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics = {Rectangle(rotation = 0, lineColor = {175,175,175}, fillColor = {240,255,252}, pattern = LinePattern.Solid, fillPattern = FillPattern.Solid, lineThickness = 0.25, extent = {{-74,78},{54,-74}}),Text(rotation = 0, lineColor = {0,0,0}, fillColor = {199,169,0}, pattern = LinePattern.Solid, fillPattern = FillPattern.Sphere, lineThickness = 0.25, extent = {{-60,-80},{40,-100}}, textString = "%name"),Rectangle(rotation = 0, lineColor = {175,175,175}, fillColor = {170,213,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.Sphere, lineThickness = 0.25, extent = {{-80,80},{-74,-74}}),Rectangle(rotation = 0, lineColor = {175,175,175}, fillColor = {170,213,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.Sphere, lineThickness = 0.25, extent = {{54,80},{60,-74}}),Rectangle(rotation = 0, lineColor = {175,175,175}, fillColor = {170,213,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.Sphere, lineThickness = 0.25, extent = {{-74,-68},{54,-74}})}));
    end GlasOfWater;
    ...
    equation
      a.Q = -b.Q;
      a.Q = U * A * (a.T - b.T);
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics = {Rectangle(extent = {{-80,40},{80,20}}, lineColor = {127,0,0}, fillColor = {215,215,215}, fillPattern = FillPattern.CrossDiag),Rectangle(extent = {{-80,-20},{80,-40}}, lineColor = {127,0,0}, fillColor = {215,215,215}, fillPattern = FillPattern.CrossDiag),Line(points = {{0,18},{0,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{20,18},{20,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{60,18},{60,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{40,18},{40,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{-20,18},{-20,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{-40,18},{-40,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5),Line(points = {{-60,18},{-60,-18}}, color = {255,0,0}, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}, thickness = 0.5)}));
    end Convection;
  end Components;
  package Examples
    ...
    model TwoWeights "Two hot weights placed in a glass of cold water"
      ...
      Components.Convection convection2(U = 1000, A = 1) annotation(Placement(transformation(extent = {{-10,-10},{10,10}}, rotation = 90, origin = {-34,58})));
