...
package TermEq "Excercise in thermodynamic equilibrium"
  ...
  package Components
    model Weight "Weight with a thermal inertia"
      ...
      annotation(Icon(coordinateSystem(preserveAspectRatio=false,  extent={{-100,
                -100},{100,100}}),                                                                    graphics={  Rectangle(extent = {{-60,60},{40,-80}}, lineColor = {135,135,135},
    ...
    model GlasOfWater
      "Cylindrical glass of water filled to the top and some displacing some of the water"
      extends ThermalCapacitance;
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics), Icon(
            coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}}),                                                                                               graphics={  Rectangle(rotation = 0, lineColor = {175,175,175}, fillColor = {240,255,252}, pattern = LinePattern.Solid,
    ...
    model ThermalCapacitance "Thermal capacitance"
      ...
      Interfaces.ThermalNode tn(T(start = T_init)) annotation(Placement(transformation(extent = {{28,-20},{48,0}}), iconTransformation(extent={{30,-20},
                {50,0}})));
    equation
    ...
    model Convection "Convective heat transfer"
      ...
      Interfaces.ThermalNode a annotation(Placement(transformation(extent = {{-10,40},{10,60}}), iconTransformation(extent={{-10,38},
                {10,58}})));
      Interfaces.ThermalNode b annotation(Placement(transformation(extent = {{-10,-60},{10,-40}}), iconTransformation(extent={{-10,-58},
                {10,-38}})));
    equation
      a.Q = -b.Q;
      a.Q = U * A * (a.T - b.T);
      annotation(Icon(coordinateSystem(preserveAspectRatio=false,  extent={{-100,
                -100},{100,100}}),                                                                    graphics={  Rectangle(extent = {{-80,40},{80,20}}, lineColor = {127,0,0}, fillColor = {215,215,215},
  ...
  package Examples
    model ConvectiveHeatLoss
      ...
      Components.GlasOfWater glasOfHotWater(T_init=373.15)
                                                          annotation(Placement(transformation(extent = {{-78,-16},{-20,42}})));
    equation
      connect(glasOfHotWater.tn, convection.a)
                                           annotation(Line(points={{-37.4,10.1},
              {-18.1,10.1},{-18.1,10},{5.2,10}},                                                                    color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(convection.b, ambientTemperature.thermalNode)
                                                         annotation(Line(points={{14.8,10},
              {43,10}},                                                                              color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      annotation(Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100,-100},{100,100}}), graphics), experiment(StopTime=
              5000),                                                                                                    experimentSetupOutput);
    ...
    model OneWeight "One hot weight placed in a glass of water"
      ...
      Components.Convection convectionToAmbient(A=sG, U=500)
                                                        annotation(Placement(transformation(extent = {{-24,-48},{-4,-28}})));
      Components.Convection convectionToWeight(U=1000, A=sW)
                                                          annotation(Placement(visible = true, transformation(origin = {-32,-4}, extent = {{10,-10},{-10,10}}, rotation = 90)));
    ...
    equation
      connect(glasOfColdWater.tn, convectionToAmbient.a)
                                           annotation(Line(points={{24,-4},{-14,
              -4},{-14,-33.2}},                                                                     color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(weight.tn, convectionToWeight.a)
                                       annotation(Line(points={{-52,-4},{-36.8,
              -4}},                                                                                          color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(convectionToWeight.b, glasOfColdWater.tn)
                                            annotation(Line(points={{-27.2,-4},
              {24,-4}},                                                                    color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(ambientTemperature.thermalNode, convectionToAmbient.b)
                                                         annotation(Line(points={{-14,-57},
              {-14,-42.8}},                                                                              color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      annotation(Diagram(coordinateSystem(preserveAspectRatio=false,  extent={{-100,
                -100},{100,100}}),                                                                       graphics), experiment(StopTime = 1800), experimentSetupOutput, Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100,-100},{100,100}}), graphics));
    end OneWeight;
    ...
    model TwoWeights "Two hot weights placed in a glass of cold water"
      ...
      Components.Convection convectionToAmbient(A=sG, U=500)
                                                        annotation(Placement(transformation(extent = {{-24,-48},{-4,-28}})));
      Components.Weight weight1(V = weight2.V, T_init = 473.15) annotation(Placement(transformation(extent={{-72,50},
                {-50,68}})));
      Components.Convection convection2(U = 1000, A = 1) annotation(Placement(transformation(extent={{-10,-10},
                {10,10}},
            rotation=90,
            origin={-34,58})));
    ...
    equation
      connect(glasOfColdWater.tn, convectionToAmbient.a)
                                           annotation(Line(points={{24,-4},{-14,
              -4},{-14,-33.2}},                                                                     color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(weight2.tn, convection1.a)
                                       annotation(Line(points={{-52,-4},{-36.8,
              -4}},                                                                                          color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(convection1.b, glasOfColdWater.tn)
                                            annotation(Line(points={{-27.2,-4},
              {24,-4}},                                                                    color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(ambientTemperature.thermalNode, convectionToAmbient.b)
                                                         annotation(Line(points={{-14,-57},
              {-14,-42.8}},                                                                              color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(convection2.b, glasOfColdWater.tn)
                                            annotation(Line(points={{-29.2,58},
              {0,58},{0,-4},{24,-4}},                                                                    color = {135,135,135}, thickness = 0.5, smooth = Smooth.None, arrow = {Arrow.None,Arrow.Filled}));
      connect(weight1.tn, convection2.a) annotation (Line(
          points={{-56.6,58.1},{-36,58.1},{-36,58},{-38.8,58}},
          color={135,135,135},
          smooth=Smooth.None));
      annotation(Diagram(coordinateSystem(preserveAspectRatio=false,  extent={{-100,
                -100},{100,100}}),                                                                       graphics), experiment(StopTime = 1800), experimentSetupOutput, Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100,-100},{100,100}}), graphics));
